...
use neptune_privacy::api::export::GenerationSpendingKey;
...
use neptune_privacy::api::export::SymmetricKey;
use neptune_privacy::api::export::Timestamp;
use neptune_privacy::api::export::TxCreationArtifacts;
use neptune_privacy::application::rpc::auth;
use neptune_privacy::application::rpc::server::error::RpcError;
use neptune_privacy::application::rpc::server::mempool_transaction_info::MempoolTransactionInfo;
use neptune_privacy::application::rpc::server::overview_data::OverviewData;
use neptune_privacy::application::rpc::server::ui_utxo::UiUtxo;
use neptune_privacy::application::rpc::server::RpcResult;
use neptune_privacy::protocol::peer::peer_info::PeerInfo;
...
impl MockRpcClient {
    ...
    pub async fn next_receiving_address(
        ...
        let receiving_address = match address_type {
            ...
            KeyType::Symmetric => {
                state.symmetric_address = neptune_privacy::api::export::ReceivingAddress::Symmetric(
    ...
    pub async fn clear_standing_by_ip(
        ...
        tokio::task::yield_now().await;
        // can't modify PeerInfo from outside xnt-core crate since all fields and
