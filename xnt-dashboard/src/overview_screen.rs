...
use neptune_privacy::protocol::consensus::block::block_header::BlockHeader;
...
use neptune_privacy::state::mining::mining_status::MiningStatus;
use neptune_privacy::state::sync_status::SyncStatus;
use neptune_privacy::state::transaction::tx_proving_capability::TxProvingCapability;
    ...
    fn render(self, area: ratatui::layout::Rect, buf: &mut ratatui::buffer::Buffer) {
        ...
        lines.push(format!(
            ...
            dashifnotset!(data
                ...
                .and_then(neptune_privacy::utc_timestamp_to_localtime)
                .map(|ts| ts.to_string())),
        ));
