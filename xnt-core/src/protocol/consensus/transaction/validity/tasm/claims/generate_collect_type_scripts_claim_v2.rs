...
pub(crate) struct GenerateCollectTypeScriptsClaimV2;

impl GenerateCollectTypeScriptsClaimV2 {
    const BAD_SIZE_INDICATOR_TYPE_SCRIPT_HASHES: i128 = 1_000_500;
}

impl BasicSnippet for GenerateCollectTypeScriptsClaimV2 {
    ...
    fn entrypoint(&self) -> String {
        "tasm_neptune_claims_generate_collect_type_scripts_claim_v2".to_owned()
    }
    ...
    fn code(&self, library: &mut Library) -> Vec<LabelledInstruction> {
        ...
        let push_cts_program_hash = {
            let Digest([d0, d1, d2, d3, d4]) = CollectTypeScriptsV2.program().hash();
...
mod tests {
    ...
    #[test]
    fn unit_test() {
        ShadowedFunction::new(GenerateCollectTypeScriptsClaimV2).test();
    }

    impl Function for GenerateCollectTypeScriptsClaimV2 {
        fn rust_shadow(
            &self,
